        ...
        public SubmissionGuideForm()
        {
            ...
            var text = new TextBox
            {
                ...
                Text =
                    ...
                    "- author：建议填写，显示用作者名。\r\n" +
                    "- category：必填，软件分类。可填：应用软件、盲用辅助、编程开发、连洛聊天、媒体工具、网络工具、文字处理、系统工具、语音库、音视频处理、游戏娱乐。\r\n" +
                    ...
                    "\r\n" +
                    "六、上传和编辑规则\r\n" +
                    "- 第一个版本上传校验通过后状态为草稿，草稿不会出现在商店主列表，需要投稿者手动上架。\r\n" +
                    "- 已有软件上传新版本时，版本号必须高于当前版本；上传成功后新版本会直接上架，不需要再到我的投稿里手动上架。\r\n" +
                    "- 我的投稿按软件显示最新版本，不会按每个历史版本显示多条记录。\r\n" +
                    "- 已有版本只能编辑软件名称、简介和分类。\r\n" +
